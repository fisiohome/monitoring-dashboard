...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            const API_URL = process.env.NEXT_PUBLIC_API_BASE_URL || "https://api-staging.fisiohome.id";
        ...
        <div className="flex min-h-screen w-full font-sans">
            ...
            <div className="hidden lg:flex w-[60%] flex-col justify-center bg-[#6200EE] p-16 text-white relative overflow-hidden">
                ...
                <div className="max-w-xl z-10 mt-10">
                    ...
                    <p className="text-lg leading-relaxed opacity-90 mb-8">
                        Fisiohome adalah layanan home visit fisioterapi yang membawa perawatan fisioterapi berkualitas langsung ke pintu rumah Anda. Dengan Fisiohome, Anda dapat menikmati perawatan fisioterapi yang nyaman dan personal tanpa harus pergi ke klinik atau rumah sakit.
                    </p>
                    {/* Pagination dots */}
            ...
            <div className="flex flex-1 flex-col justify-center items-center bg-white p-8">
                ...
                <div className="w-full max-w-md space-y-8 bg-white p-8 border border-slate-100 rounded-3xl shadow-xl shadow-slate-200/50">
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight text-slate-900 mb-2">Log In</h2>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                <Label htmlFor="password" className="text-slate-600 font-medium">Kata sandi</Label>
                            </div>
                            <Input
                                id="password"
                                type="password"
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                                <input type="checkbox" id="remember" className="rounded border-gray-300 text-[#6200EE] focus:ring-[#6200EE]" />
                                <label htmlFor="remember" className="text-sm text-slate-500">Ingat saya</label>
                            </div>
                        </div>
