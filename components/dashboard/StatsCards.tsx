    ...
    >
      ...
      <CardContent className="p-6 flex flex-col justify-between h-full relative z-10">
        <div className="flex justify-between items-start mb-4">
          <span
            className={cn(
              "text-sm font-medium leading-tight mr-2",
          ...
          <div
            className={cn(
              ...
              isPrimary
                ? "bg-white/20 backdrop-blur-sm text-white shadow-inner border border-white/10"
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <StatsCard
        ...
        value={revenue.total_this_month.toLocaleString("id-ID", {
          style: "currency",
          currency: "IDR",
      ...
      <StatsCard
        ...
        subtext={`${orders.rate > 0 ? orders.rate : orders.total_today > 0 ? Math.round((orders.success / orders.total_today) * 100) : 0}% rate`}
        icon={CheckCircle}
      />
      <StatsCard
